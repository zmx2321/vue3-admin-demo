...
const setIndexMarkerConfig = (lonlat, markerClass, item) => {
  ...
  el.addEventListener('mouseover', () => {
    ...
    mapUtils.setPopupCommon(glMapData, lonlat, popupConfig.mainPopup(mainPopupData.value.mpdt0)) // 首页大屏气泡
  })
        ...
        table {
          ...
          tbody {
            tr {
              ...
              &:nth-child(odd) {
                background: rgba(79, 135, 228, 0.2);
              }
            }
          }
        }
